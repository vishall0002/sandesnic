...
class GroupType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        //     'help' => 'The actual group name created will be displayed as below. Please type only the relevant part in above input box, ALNUM in smaller case and - [hiphen] are the only allowed inputs ',
        // ]);
        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
            ...
            if ($profile) {
                ...
                elseif ($this->security->isGranted('ROLE_GROUP_ADMIN')) {

 ...
 * List_Publishers.
 *
 * @ORM\Table(name="gim.list_subscriber_states")
 * @ORM\Entity
 */
class SubscriberState {
     ...
     * @var int
     *
     * @ORM\Column(name="list_subscriber_state_id", type="integer")
     * @ORM\Id
    ...
    public function getSubscriber(): ?State
    {
        return $this->subscriber;
    }

    public function setSubscriber(?State $subscriber): self
    {

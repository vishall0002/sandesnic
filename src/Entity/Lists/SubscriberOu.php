 ...
 * List_Publishers.
 *
 * @ORM\Table(name="gim.list_subscriber_ous")
 * @ORM\Entity
 */
class SubscriberOu {
     ...
     * @var int
     *
     * @ORM\Column(name="list_subscriber_ou_id", type="integer")
     * @ORM\Id
     ...
     * @ORM\JoinColumn(name="ou_id", referencedColumnName="ou_id",nullable=false)
     */
    private $subscriber;
    ...
    public function getSubscriber(): ?OrganizationUnit
    {
        return $this->subscriber;
    }

    public function setSubscriber(?OrganizationUnit $subscriber): self
    {
